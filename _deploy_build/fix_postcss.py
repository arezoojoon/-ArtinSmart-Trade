...
LOCAL_CONFIG = 'I:\\AI WhatsApp Sales & Lead Intelligence Platform for FMCG\\postcss.config.js'
...
print("--- Fixing PostCSS & Rebuilding ---")
...
# 1. Upload new config
print("Uploading postcss.config.js...")
sftp.put(LOCAL_CONFIG, '/var/www/fmcg/postcss.config.js')

# 2. Cleanup old config
run_command(client, "rm /var/www/fmcg/postcss.config.mjs")
