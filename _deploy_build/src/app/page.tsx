    ...
    <div className="min-h-screen bg-black text-white selection:bg-accent selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-lg border-b border-white/10">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-accent rounded-lg flex items-center justify-center font-bold">T</div>
            <span className="font-bold text-xl tracking-tight">TradeMate AI</span>
          </div>
      ...
      <div className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-3 py-1 mb-8 animate-in fade-in slide-in-from-bottom-5 duration-700">
            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
            <span className="text-xs font-medium text-gray-300">Gemini 1.5 Pro Live</span>
          </div>
          ...
          <div className="flex-1 flex justify-center relative">
            <div className="w-[300px] h-[600px] bg-gray-900 border-8 border-gray-800 rounded-[3rem] p-4 relative shadow-2xl rotate-3 hover:rotate-0 transition duration-500">
              <div className="w-full h-full bg-black rounded-[2rem] overflow-hidden relative">
                {/* Mock Screen Content */}
                <div className="absolute inset-0 bg-gradient-to-b from-black to-gray-900 flex items-center justify-center text-gray-500">
                  App Preview
                </div>
              </div>
            </div>
      ...
      <footer className="py-12 border-t border-white/10 text-center text-gray-500 text-sm">
        <p>&copy; 2026 TradeMate AI. All rights reserved.</p>
      </footer>
    </div>
  );
}
