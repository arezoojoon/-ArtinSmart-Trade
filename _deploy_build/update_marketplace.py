...
print("--- Updating Marketplace (Phase 5) ---")
...
for rel_path in FILES_TO_UPLOAD:
    ...
    # Handle windows path separators and brackets in filenames for remote path
    remote_rel_path = rel_path.replace(os.path.sep, '/')
    remote_path = f"{REMOTE_ROOT}/{remote_rel_path}"
