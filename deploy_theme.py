...
paramiko.util.log_to_file("paramiko_theme.log")
...
try:
    ...
    # Files to deploy
    files_to_deploy = [
        ("tailwind.config.ts", "/root/fmcg-platform/tailwind.config.ts"),
        ("src/app/globals.css", "/root/fmcg-platform/src/app/globals.css"),
    ]
