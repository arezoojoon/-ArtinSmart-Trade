...
paramiko.util.log_to_file("paramiko_kpi.log")
...
try:
    ...
    files_to_deploy = [
        ...
        ("src/app/dashboard/marketplace/page.tsx", "/root/fmcg-platform/src/app/dashboard/marketplace/page.tsx"),
        ("update_marketplace_v2.sql", "/root/fmcg-platform/update_marketplace_v2.sql"),
    ]
    ...
    ssh.close()
    print("KPI & Algo Updates Deployed!")
