...
FILES_TO_UPLOAD = [
    ...
    # Re-uploading gap-analysis just in case
    ("src/app/leads/gap-analysis/page.tsx", "src/app/leads/gap-analysis/page.tsx"),
]

def deploy_analytics_fix():
    ...
    try:
        ...
        client.exec_command(f"mkdir -p {BASE_REMOTE}/src/app/\(dashboard\)/analytics")
        client.exec_command(f"mkdir -p {BASE_REMOTE}/src/app/leads/gap-analysis")
        ...
        print("\n✅ Analytics & Gap Analysis Deployed.")
        client.close()
