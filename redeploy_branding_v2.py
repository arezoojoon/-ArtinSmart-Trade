...
def redeploy_branding():
    ...
    try:
        ...
        files = [
            ...
            (r"I:\AI WhatsApp Sales & Lead Intelligence Platform for FMCG\src\app\whatsapp\simulator\page.tsx", "/root/fmcg-platform/src/app/(dashboard)/whatsapp/simulator/page.tsx"),
        ]
        ...
        for local, remote in files:
            ...
            if os.path.exists(local):
                ...
                print(f"⚠️ Missing local file: {local}")

        # Upload Logo Separately
        logo_local = r"I:\AI WhatsApp Sales & Lead Intelligence Platform for FMCG\public\logo.png"
        logo_remote = "/root/fmcg-platform/public/logo.png"
        
        if os.path.exists(logo_local):
            print(f"Uploading logo.png...")
            try:
                sftp.put(logo_local, logo_remote)
            except Exception as e:
                print(f"⚠️ Failed to upload logo: {e}")
        else:
             print(f"⚠️ Local logo.png not found at {logo_local}")
